import styles from './footer-bunny.module.css'

type FooterBunnyProps = {
  size?: number
  sleeping?: boolean
  color?: string
}

export function FooterBunny({
  size = 24,
  sleeping = false,
  ...
  return (
    ...
    >
      <g transform="translate(6, 8)">
        <g
          transform={
            sleeping ? 'rotate(-15, 7, 10) translate(0, 1)' : undefined
          }
        >
          <path
            className={sleeping ? styles.earLeftSleep : styles.earLeftAwake}
        ...
        <g
          transform={
            sleeping ? 'rotate(15, 19, 10) translate(0, 1)' : undefined
          }
        >
          <path
            className={sleeping ? styles.earRightSleep : styles.earRightAwake}
      ...
      {sleeping && (
        <g stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none">
          <g className={styles.zFloat1} strokeWidth="1.5">
            <path d="M32 5 L36 5 L32 9 L36 9" />
          </g>
          <g className={styles.zFloat2} strokeWidth="1.3">
            <path d="M34 3 L37 3 L34 6 L37 6" />
          </g>
          <g className={styles.zFloat3} strokeWidth="1.1">
